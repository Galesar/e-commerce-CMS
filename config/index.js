...
class Config {
  constructor(env = process.env) {
    ...
    this.mongoDbUrl = 'mongodb://127.0.0.1:27017/e-cms';
    this.smtpServer = {
      host: '',
      port: 465,
      secure: true,
    ...
    this.pagesUploadPath = 'public/content/images/pages';
    this.pagesUploadUrl = '/images/pages';
    this.shopsUploadPath = 'public/content/images/shops';
    this.shopsUploadUrl = '/images/shops';
    this.orderGiftsUploadPath = 'public/content/images/orderGifts';
    this.orderGiftsUploadUrl = '/images/orderGifts';
    ...
    this.storeBaseUrl = 'http://localhost:3000';
    this.discountsForWholesalerCustomers = [30000, 55000, 110000, 350000, 750000, 1500000];
