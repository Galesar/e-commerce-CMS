...
const addOrderConfirmationEmailTemplates = async () => {
  ...
  if (emailTemplatesNotExists) {
    await models.EmailTemplatesModel.create({
      ...
      body: `<div>
			<div><b>Номер заказа</b>: {{number}}</div>
			<div><b>Метод доставки</b>: {{shipping_method}}</div>
			<div><b>Метод оплаты</b>: {{payment_method}}</div>
		  
      <div style="width: 100%; margin-top: 20px;">
			  <b>Название магазина</b>: {{shop.name}}<br />
			  <b>Время работы</b>: {{shop.work_time}}<br />
			  <b>Номер для связи</b>: {{shop.phone}}<br />
			</div>

			<div style="width: 100%; margin-top: 20px;">
			  <b>ФИО</b>: {{full_name}}<br />
        <b>Номер телефона</b>: {{mobile}}<br />
			  <b>Город</b>: {{shipping_address.city}}<br />
			  <b>Улица</b>: {{shipping_address.street}}<br />
			  <b>Дом</b>: {{shipping_address.house}}<br />
			</div>
      ...
      <div style="width: 100%; margin-top: 20px;">
			...
			<table style="width: 100%; margin-top: 20px;">
			  <tr>
				...
				<td style="width: 22.5%; padding: 10px 0px; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; text-align: right;">Цена</td>
				<td style="width: 15%; padding: 10px 0px; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; text-align: right;">Кол.</td>
				<td style="width: 22.5%; padding: 10px 0px; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; text-align: right;">Итог</td>
			  </tr>
		  
			  {{#each items}}
			  <tr>
				<td style="padding: 10px 0px; border-bottom: 1px solid #ccc; text-align: left;">{{name}}</td>
				<td style="padding: 10px 0px; border-bottom: 1px solid #ccc; text-align: right;">{{price}} р</td>
				<td style="padding: 15px 0px; border-bottom: 1px solid #ccc; text-align: right;">{{quantity}}</td>
				<td style="padding: 10px 0px; border-bottom: 1px solid #ccc; text-align: right;">{{price_total}} р</td>
			  </tr>
			  {{/each}}
			...
			<table style="width: 100%; margin: 20px 0;">
			  <tr>
				<td style="width: 80%; padding: 10px 0px; text-align: right;"><b>Подытог</b></td>
				<td style="width: 20%; padding: 10px 0px; text-align: right;">{{subtotal}} рублей</td>
			  </tr>
			  <tr>
				<td style="width: 80%; padding: 10px 0px; text-align: right;"><b>Доставка</b></td>
				<td style="width: 20%; padding: 10px 0px; text-align: right;">{{shipping_total}} рублей</td>
			  </tr>
			  <tr>
				<td style="width: 80%; padding: 10px 0px; text-align: right;"><b>Общая сумма заказа</b></td>
				<td style="width: 20%; padding: 10px 0px; text-align: right;">{{grand_total}} рублей</td>
			  </tr>
			</table>
